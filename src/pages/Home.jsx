                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-2 ">
                            Desenvolvedora Full Stack entusiasmada por tecnologia, com eexperiência tanto em frontend quanto backend, além de desenvolvimento de aplicativos mobile e softwares. Meu foco está sempre na qualidade do código e na experiência do usuário final.
                        </p>
                    </div>
                    
                    <div className="flex flex-col lg:flex-row gap-12 items-start">
                        <div className="flex-1 lg:w-1/2">
                            <h3 className="text-2xl md:text-3xl text-gray-900 dark:text-white mb-6" style={{fontFamily: 'Poppins, sans-serif'}}>
                                Minha Jornada
                            </h3>
                            <p className="text-base md:text-sm text-gray-600 dark:text-gray-300 mb-4 leading-relaxed text-justify">
                        ...
                        {/* Lado direito - Botões na esquerda e conteúdo na direita */}
            ...
            <section id="skills" className="py-20 bg-gray-50 dark:bg-gray-900">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex justify-center">
                        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4 max-w-6xl">
                            {/* JavaScript */}
                            <div className="flex flex-col items-center group">
                            <div className="w-16 h-16 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-200">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {visibleCertificates.map((certificate, index) => (
                                    <div 
                                        ...
                                        className="group bg-white dark:bg-gray-700 rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-2 cursor-pointer border-2 border-transparent hover:border-blue-500"
                                        style={{ 
                                    ...
                                    >
                                        ...
                                        <div className="p-4 group-hover:bg-blue-50 dark:group-hover:bg-gray-600 transition-colors duration-300">
                                            ...
                                            {/* Indicador de hover */}
                                            <div className="mt-3 flex items-center text-blue-600 dark:text-blue-400 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0">
                                                <span className="text-sm font-medium mr-2">Clique para ampliar</span>
